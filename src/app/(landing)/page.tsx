...
export default async function Home() {
  return (
    <main className="container relative mx-auto max-w-7xl overflow-hidden bg-dot-black/[0.2] dark:bg-dot-white/[0.2]">
      ...
      <section className="relative flex h-full min-h-screen w-full animate-fade-up flex-nowrap items-center justify-center overflow-hidden lg:overflow-visible">
